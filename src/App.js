  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/Donate-for-pandikkad-santhwanam-palliative-care-society" element={<Donation />} />
        ...
        <Route path="/Payasa-challenge-2025-orderform-pandikkad-palliative" element={<SubmitForm />} />
        <Route path="/order-success" element={<OrderSuccess />} />
        <Route path="/Pandikkad-santhwanam-palliative-payasa-challenge-trending-now" element={<Trandingpage/>} />
